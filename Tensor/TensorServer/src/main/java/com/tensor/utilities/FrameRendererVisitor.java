...
import com.tensor.examples.KinesisVideoFrameViewer;
...
public class FrameRendererVisitor extends CompositeMkvElementVisitor {
    ...
    public static FrameRendererVisitor create(KinesisVideoFrameViewer kinesisVideoFrameViewer) {
        return new FrameRendererVisitor(com.tensor.utilities.FragmentMetadataVisitor.create(), kinesisVideoFrameViewer);
    }
    ...
    private class FrameVisitorInternal extends MkvElementVisitor {
        @Override
        public void visit(com.tensor.mkv.MkvStartMasterElement startMasterElement) throws com.tensor.mkv.MkvElementVisitException {
        }

        @Override
        public void visit(com.tensor.mkv.MkvEndMasterElement endMasterElement) throws com.tensor.mkv.MkvElementVisitException {
        }

        @Override
        public void visit(com.tensor.mkv.MkvDataElement dataElement) throws com.tensor.mkv.MkvElementVisitException {
